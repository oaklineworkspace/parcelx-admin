...
function UserDetail() {
  ...
  if (!supabaseConfigured) {
    return (
      <Stack gap="lg">
        <Group>
          <Button variant="subtle" leftSection={<IconArrowLeft size={16} />} onClick={() => navigate('/users')}>
            Back
          </Button>
          <Title order={2}>User Profile</Title>
        </Group>
        <Alert icon={<IconInfoCircle size={16} />} title="Supabase Not Configured" color="blue">
          To view user details, add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to your environment variables.
        </Alert>
      </Stack>
    )
  }
