...
function CreateShipment() {
  ...
  return (
    <Stack gap="lg">
      <Group>
        <Button variant="subtle" leftSection={<IconArrowLeft size={16} />} onClick={() => navigate('/shipments')}>
          Back
        </Button>
      ...
      {!supabaseConfigured && (
        <Alert icon={<IconInfoCircle size={16} />} title="Supabase Not Configured" color="blue">
          To create shipments, add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to your environment variables.
        </Alert>
      )}
        ...
        <form onSubmit={handleSubmit((data) => createMutation.mutate(data))}>
          <Stack gap="md">
            ...
            <Group justify="flex-end" mt="md">
              <Button variant="light" onClick={() => navigate('/shipments')}>Cancel</Button>
