...
import { 
  ...
  Pagination, Avatar, Tooltip, Alert 
} from '@mantine/core'
import { 
    ...
    <Stack gap="lg">
      ...
      {!supabaseConfigured && (
        <Alert icon={<IconInfoCircle size={16} />} title="Supabase Not Configured" color="blue">
          To manage users, add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to your environment variables.
        </Alert>
      )}
                    ...
                    <Table.Td>
                      <Group gap="xs">
                        <Tooltip label="View Details">
                          <ActionIcon variant="light" onClick={() => navigate(`/users/${user.id}`)}>
                            <IconEye size={16} />
                          </ActionIcon>
                        </Tooltip>
